...
<td class="text-end"><a href="{{ route('courses.progress-export',$course) }}" class="btn btn-sm btn-outline-success" title="Export Progress (CSV)"><i class="fa-solid fa-file-csv"></i></a> <a href="{{ route('courses.edit',$course) }}" class="btn btn-sm btn-outline-primary"><i class="fa-solid fa-pen"></i></a> <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-url="{{ route('courses.destroy',$course) }}" data-name="{{ $course->title }}"><i class="fa-solid fa-trash"></i></button></td></tr>
