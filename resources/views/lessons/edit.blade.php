...
@if($lesson->attachment_path)<div class="form-text"><a href="{{ Storage::url($lesson->attachment_path) }}" target="_blank" class="text-decoration-none"><i class="fa-solid fa-file-pdf me-1"></i>Current PDF</a> — uploading a new file will replace it.</div>@endif</div>
